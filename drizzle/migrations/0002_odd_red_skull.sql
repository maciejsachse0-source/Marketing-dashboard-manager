...
--> statement-breakpoint
INSERT INTO `__new_productions`("id", "type", "template_slug", "status", "title", "slug", "t0_at", "artist_id", "videographer_id", "platforms", "campaign_id", "folder_path", "notes", "created_at") SELECT "id", "type", "template_slug", "status", "title", "slug", "t0_at", "artist_id", "videographer_id", "platforms", "campaign_id", "folder_path", "notes", "created_at" FROM `productions`;--> statement-breakpoint
