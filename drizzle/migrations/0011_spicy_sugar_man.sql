...
INSERT INTO `__new_productions`("id", "type", "title", "slug", "t0_at", "steps", "cancelled_at", "artist_id", "videographer_id", "platforms", "campaign_id", "folder_path", "notes", "created_at") SELECT "id", "type", "title", "slug", "t0_at", "steps", "cancelled_at", "artist_id", "videographer_id", "platforms", "campaign_id", "folder_path", "notes", "created_at" FROM `productions`;--> statement-breakpoint
